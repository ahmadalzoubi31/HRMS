...
class Employee {
  ...
  public findAll(): any {
    ...
    db.query(sqlQuery, (err: object, docs: object) => {
      if (err) return err;
      return docs;
    });
  }

  public findOne(employeeID, result) {
  ...
  public create(newEmployee, result) {
  ...
  public update(employeeID, updateEmployee, result) {
  ...
  public delete(employeeID, result) {
