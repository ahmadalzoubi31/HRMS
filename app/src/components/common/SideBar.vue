<template>
  ...
  <div class="flex flex-row min-h-screen bg-gray-100 text-gray-800">
    <aside
        class="sidebar w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-teal-500"
    >
...
<!--              />-->
<!--            </svg>-->
            <span class="leading-10 text-gray-100 text-2xl font-bold ml-1 uppercase">HRMS</span>
          </a>
        </div>
      </div>
      <div class="sidebar-content px-4 py-6">
        <ul class="flex flex-col w-full">
          ...
          <li class="my-px">
            <span class="flex font-medium text-sm text-gray-700 px-4 my-4 uppercase">Projects</span>
          </li>
          <li class="my-px">
            <a
                href="#"
          ...
          <form action="#">
            <div class="hidden md:flex relative">
              ...
              <input
                  ...
                  type="text"
                  name="search"
                  class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-300 w-full h-10 focus:outline-none focus:border-teal-400"
                  placeholder="Search..."
              />
            </div>
